...
def Credit():
  tk.messagebox.showinfo(title='Credit', message='Created By Mohamed Yanis HIOU\n     www.medyanis-hiou.me')
...
def translate():
        ...
        if language_1 == '':
                messagebox.showerror("Yanis's Translator",'please fill the box')
        else:
...
btn = Button(root,text='Credit' ,relief=RIDGE,borderwidth=3,font=('verdana',10,'bold'),cursor="hand2" ,command=Credit)
btn.place(x=230,y=330)
